...
router.post('/', async (req, res) => {
    const { employeeId, name, position, baseSalary, overtimeHours, totalSalary } = req.body; // Added employeeId

    const newOvertime = new Overtime({ employeeId, name, position, baseSalary, overtimeHours, totalSalary }); // Included employeeId
...
router.put('/:id', async (req, res) => {
    ...
    try {
        const updatedOvertime = await Overtime.findByIdAndUpdate(id, {
            employeeId, // Included employeeId
            name,
            position,
            baseSalary,
            overtimeHours,
